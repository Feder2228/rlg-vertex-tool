from modules import util, xmllib, model3dlib
...
def read_dae( filepath ):
    ...
    daefile = open( filepath, "r" )

    model3d = model3dlib.Model3d()


    xml_root_node = xmllib.get_xml_tree( daefile )
    ...
    for i, geometry_tag in enumerate(geometry_tags):
        ...
        for j, vertex_position in enumerate(vertex_positions):
            ...
            new_vertex =  model3dlib.Vertex( vertex_absolute_id, j, 0, i, vertex_position, vertex_normals[j],
