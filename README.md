...
You can edit the .dae you extracted to make a 3d model edit, but only vertices will be read by the tool. Anything else is ignored for now.
...
3. In the output folder you'll find the newly created .dae file, import it in a 3D model editor (such as blender). Here you can move the vertices around, but you **DO NOT** add or delete any.
